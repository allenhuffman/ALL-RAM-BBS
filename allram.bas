...
560 OPEN"I",#DV,"USERLOG":INPUT#DV,CL,NM:FORA=0TONM:INPUT#DV,NM$(A):NEXTA:CLOSE
565 OPEN"I",#DV,"MSG BASE":INPUT#DV,MS:FORA=0TOMS-1:FORB=0TO10:INPUT#DV,MS$(A,B):NEXTB:NEXTA:CLOSE:RETURN
600 '%SAVE%
605 PRINT"%SAVE% [ENTER] WHEN READY";:GOSUB1005:MOTORON:FORA=0TO999:NEXTA
610 OPEN"O",#DV,"USERLOG":PRINT#DV,CL,NM:FORA=0TONM:PRINT#DV,NM$(A):NEXTA:CLOSE
615 OPEN"O",#DV,"MSG BASE":PRINT#DV,MS:FORA=0TOMS-1:FORB=0TO10:PRINT#DV,MS$(A,B):NEXTB:NEXTA:CLOSE:RETURN
1000 'User Input
